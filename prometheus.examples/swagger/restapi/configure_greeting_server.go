...
import (
	...
	"github.com/ray1729/go-talks/prometheus.examples/swagger/restapi/operations"
)

//go:generate swagger generate server --target ../../swagger --name GreetingServer --spec ../swagger.yml
